...
public final class DijkstraShortestPath<V, E> {
	...
	public DijkstraShortestPath(Graph<V, E> graph, V startVertex, V endVertex,
		...
		ClosestFirstIterator<V, E> iter = new ClosestFirstIterator<V, E>(graph,
				startVertex, radius);
	...
	public static <V, E> List<E> findPathBetween(Graph<V, E> graph,
		...
		DijkstraShortestPath<V, E> alg = new DijkstraShortestPath<V, E>(graph,
	...
	private void createEdgeList(Graph<V, E> graph,
		...
		path = new GraphPathImpl<V, E>(graph, startVertex, endVertex, edgeList,
				pathLength);
	}
}
